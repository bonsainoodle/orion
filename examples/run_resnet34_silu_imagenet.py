...
log_file = log_dir / f"run_resnet34_silu_imagenet_{timestamp}.log"
...
net = models.ResNet34SiLU("imagenet")
...
output_file = log_dir / f"run_resnet34_silu_imagenet_{timestamp}.json"
